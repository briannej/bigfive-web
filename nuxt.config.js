export default {
  ...
  */
  head: {
    titleTemplate: '%s - Pesonality Test_ Atefeh Zare',
  ...
  modules: [
    ...
    [
      'nuxt-i18n',
      {
        ...
        seo: true,
        baseUrl: 'http://personality.atefehzare.com',
        defaultLocale: 'en',
  ...
  */
  ...
  sitemap: {
    hostname: 'http://personality.atefehzare.com'
  },
  webfontloader: {
    google: {
  ...
  env: {
    API_URL: 'http://personality.atefehzare.com/api/' // TODO: Fix for dev environment
  },
  build: {
    extractCSS: true,
    extend (config, ctx) {
