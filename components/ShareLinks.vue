  ...
  <div class="pt-5">
    <v-tooltip bottom>
      <template #activator="{ on }">
        <a
          v-on="on"
          @click="copyLink(`http://personality.atefehzare.com/${id}`)"
        >
    ...
    <v-tooltip bottom>
      <template #activator="{ on }">
        <a
          :href="'https://www.facebook.com/sharer/sharer.php?u=http://personality.atefehzare.com/' + id"
          target="_blank"
          rel="noopener"
    ...
    <v-tooltip bottom>
      <template #activator="{ on }">
        <a
          :href="'https://twitter.com/intent/tweet?text=See my personality traits!&url=http://personality.atefehzare.com/' + id"
          target="_blank"
          rel="noopener"
