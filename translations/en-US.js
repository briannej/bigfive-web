export default {
  language: 'English',
  seo: {
    keywords: 'big five personality test, big 5 personality test, b5 test, bigfive test, personality traits, bigfive, compare, free, atefeh zare'
  },
  frontpage: {
    seo: {
    ...
    tests_taken: 'Many have taken the test',
    compare: {
